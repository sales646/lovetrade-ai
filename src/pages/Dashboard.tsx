...
export default function Dashboard() {
  ...
  const recentSignals = [
    { symbol: "AAPL", strategy: "News Momentum", confidence: 0.87, side: "buy", time: "2 min ago" },
    { symbol: "TSLA", strategy: "VWAP Play", confidence: 0.75, side: "buy", time: "5 min ago" },
    { symbol: "MSFT", strategy: "Exhaustion Reversal", confidence: 0.82, side: "sell", time: "12 min ago" },
  ];
        ...
        {stats.map((stat) => (
          <Card key={stat.title} className="relative overflow-hidden">
            ...
            <CardContent>
              ...
              <p className={cn("text-xs flex items-center gap-1 mt-1", stat.trend === "up" ? "text-success" : "text-muted-foreground")}>
